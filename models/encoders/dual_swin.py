...
class DualSwinTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        for i_layer in range(self.num_layers):
            ...
            fr = FCM(dim=int(embed_dim*2**i_layer), reduction=16, kernel_size=3, sa_type=0)
            self.FCMs.append(fr)
            # patch merging layer
            ...
            fuse = FIM(dim=int(embed_dim*2**i_layer), reduction=16, kernel_size=3, padding=1, bias=True, groups=16)
            self.FIMs.append(fuse)
