...
C.backbone = 'mit_b2' # 'swin_l' # Remember change the path below.
C.pretrained_model = C.root_dir + '/pretrained/segformer/mit_b2.pth' # '/pretrained/swintransformer/swin_large_patch4_window12_384_22k.pth' # 
